...
A standalone brand page: `index.html`, one stylesheet, two SVGs and two self-hosted variable fonts. No build, JavaScript, analytics, CDN, app bundle changes or hosting configuration.
...
- Approved identity: vermilion nightingale on paper; README banner's optical alignment. The wordmark is live **Fraunces 600**, `opsz=144`, `SOFT=0`, `WONK=1`; body is **Newsreader**. All authored colours are paper `#F4EFE4`, ink `#14110D`, vermilion `#C8462C`.
...
The read-along is labelled as a typographic illustration, not a reskinned app screenshot, actual audio player or fabricated testimonial. The raster seal/five-state bird sheet are omitted because they are direction studies, not finished vector assets, and add no necessary information here. No fake Linux installation commands, public notarized Mac installer, Windows package, or version pin is advertised. GitHub destinations remain the real README destinations.
...
- `assets.png`: real Fraunces/Newsreader, detail mark and optical-small favicon at native sizes.
