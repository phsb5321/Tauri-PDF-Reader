...
Last reconciled: 15/08/2026, baseline main `4f74f4b`.
...
requires one clean merged SHA to carry corpus, CodeQL, Sonar, RC, macOS, and
adversarial-audit evidence together.
