> Verbatim branch-bound copy of specs/190-macos-flake/spec.md — this branch adds the CI gate on top of the mac-package slice (PR #192); authoritative chain at specs/190-macos-flake/.
