...
| Formerly local-only `143-fix-targetdir` `64248ad6` | `duplicate` | The combined branch patch-id equals merged PR #143 squash `8745d17e`. | **Preserved** as `origin/preserve/20260820-143-fix-targetdir`; do not replay it onto main. | The combined patch-id differs from `8745d17e` or a content delta is found. |
