...
- [ ] T002 Enumerate **every local ref** dynamically, prove remote containment for each tip, then record classifications, squash/tree equivalence, stale branches, dirty-worktree exclusions, and the #147/#152 merge-tree result in `docs/alignment-recovery-branch-ledger.md`
