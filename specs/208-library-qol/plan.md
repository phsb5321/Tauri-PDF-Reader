> Verbatim branch-bound copy of specs/202-library-qol/plan.md — this branch is the re-land of that slice (PR #208); the authoritative chain lives at specs/202-library-qol/.
