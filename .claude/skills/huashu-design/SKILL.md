---
name: huashu-design
description: 花叔Design（Huashu-Design）——用 HTML 做高保真原型、交互 Demo、幻灯片、动画与设计变体探索，兼设计方向顾问与专家评审。HTML 是工具不是媒介：按任务 embody 对应专家（UX 设计师/动画师/幻灯片设计师/原型师），避开 web design tropes。触发词：做原型、交互原型、HTML 演示、动画 Demo、设计变体、hi-fi 设计、UI mockup、prototype、app/iOS 原型、导出 MP4/GIF、60fps 视频、设计风格、配色方案、推荐风格、设计评审、带解说的动画、解说视频、voiceover、narration。含 Junior Designer 工作流、反 AI slop 清单、Playwright 验证、HTML 动画→MP4/GIF 导出（BGM + 插帧）、TTS 长解说 pipeline、5 流派×20 种设计哲学的方向顾问、5 维度专家评审。
---
