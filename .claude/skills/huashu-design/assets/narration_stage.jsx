...
const NarrationStageLib = (() => {
  ...
  function Scene({ id, children, keepMounted = false }) {
    ...
    const content =
      typeof children === "function" ? children(sceneTime, scene) : children;
    return (
      <div
        style={{
          position: "absolute",
  ...
  function Subtitles({
    ...
    const active = scene.chunks.find(
      (c) => time >= c.absoluteStart && time < c.absoluteEnd,
    );
    ...
    return React.createElement(
      ...
      React.createElement(
        "div",
        {
          ...
          style: {
            fontFamily:
              '"PingFang SC", "Noto Sans SC", -apple-system, sans-serif',
            fontSize,
            fontWeight: 600,
            color,
